...
<body>
    <header id="HOME" style="background-position: 80% -120px;">
    	<section>
	            ...
	            <nav class="navbar navbar-default navbar-fixed-top">
	              <div class="container">
	                ...
	                <div class="navbar-header">
	                  ...
	                  <a class="navbar-brand" href="StudyMain.room"><img src="images/logo2.png" style="width: 152px; height: 23px; "  alt=""></a>
	                </div>
	                ...
	                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	                  <ul class="nav navbar-nav navbar-right">
	                    ...
	                    <li><a href="login_form.room">로그인</a></li>
	                  </ul>
	                </div><!-- /.navbar-collapse -->
	              </div><!-- /.container -->
	            </nav> 
