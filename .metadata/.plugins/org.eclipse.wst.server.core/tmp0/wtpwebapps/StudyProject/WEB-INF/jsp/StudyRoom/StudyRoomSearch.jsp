		...
		<div class="">
				<div class="col-xs-9">
					<form action="" id="searchForm" name="searchForm" method="post">
						...
						<div class="col-xs-7">
							<input type="text" class="form-control" id="searchValue" name="searchValue" placeholder="검색어 입력">							
						</div>
						<div class="col-xs-2">
							<button type="button" class="btn btn-primary cs-btn" id="sub" onclick="sendIt()">검색</button>
						</div>	
					</form>
				</div>
		</div>
