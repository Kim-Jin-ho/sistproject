...
<head>
<meta charset="UTF-8">
<title>CmpnyQnaUpdate.jsp</title>
<!-- QNA 수정 페이지 -->
...
<body>
	...
	<div>
		...
		<!-- 최종 수정값을 넘겨 등록함 -->	
		<form action="<%=cp %>/CmpnyQnaUpdate.love?cd=${cmpnyQnaUpdateSend.cd }" id="qnaForm" name="qnaForm" method="post">
			...
			<div>
					...
					<ul>
						...
						<li>
							<input type="text" id="subject" name="subject" class="boxTF"
							 value="${cmpnyQnaUpdateSend.sbjct }" maxlength="100" size="50">
						</li>
					</ul>
				</div>	
				...
				<div>
					<ul>
						<li>내 용</li>
						<li>
							<textarea id="content" name="content" rows="10" cols="60">${cmpnyQnaUpdateSend.ctnt }</textarea>
						</li>
					</ul>
				</div>
