...
public class ProductNomalInsertController implements Controller
{
	private IProductNomalInsertDAO dao;
	
	public void setDao(IProductNomalInsertDAO dao)
	{	
		this.dao = dao;
	}
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse arg1) throws Exception
	{
		...
		{	
			...
			System.out.println("size : " + normalBigItem.size());
			...
			//mav.setViewName("/company/CompanyProductNomalInsert.jsp");
