...
public class AdminPriQnaListController implements Controller
{
	private IQnaDAO dao;
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		ArrayList<Qna> userQnaList = new ArrayList<Qna>();
		
		int start = (current_page-1) * numPerPage+1;
		
		int end = current_page * numPerPage;
		
		String listUrl = "AdminPriQnaList.love";
		...
		try
		{
			...
			mav.setViewName("admin/AdminPriQnaList.jsp");
