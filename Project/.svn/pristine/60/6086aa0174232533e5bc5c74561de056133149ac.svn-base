...
public class ProductDownOkController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse arg1) throws Exception
	{
		...
		try
		{	
			int productDown = dao.productDown(saNum);

			mav.addObject("productDown", productDown);
						
			mav.setViewName("redirect:/company/CompanyProductManagement.love");
		}
		catch (Exception e)
		{
