...
public class CmpnyQnaCreateController implements Controller
{
		...
		{
			{
				...
				// 가져온 변수로 cmpnyQnaCreate() 메소드를 사용해 QNA 글 등록
				dao.cmpnyQnaCreate(dto);
				
				// 다시 CmpnyQnaList.love 으로 보내 등록된 글을 포함한 리스트 출력
