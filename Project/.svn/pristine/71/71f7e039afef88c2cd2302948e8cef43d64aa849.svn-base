...
public class CheckWarningController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		ArrayList<Cmpny> warningList = new ArrayList<Cmpny>();
		...
		try 
		{
			warningList = dao.warningList(cmpny_id);
		...
		mav.setViewName("admin/checkWarning.jsp");
